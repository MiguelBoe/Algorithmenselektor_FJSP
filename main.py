...
if solver == "google":
    ...
    schedule_dict = visualize_schedule(
        assigned_jobs=assigned_jobs, all_machines=all_machines, plan_date=0
    )
elif solver == "meta":
...
# Visualization
fig = ff.create_gantt(
    schedule_dict, index_col="Resource", show_colorbar=True, group_tasks=True
)
