...
from tasks import ScheduledTask, Task


def giffler_thompson(jobs_data: JobList) -> Schedule:
    """
...
# def get_prio_task_LRPT(task_on_machine: list[Task], jobs_data: JobList) -> Task:
#     """Wenn mehr als ein Task zuweisbar ist soll anhand der LPT regel der Task bestimmt werden, welcher zuerst eingeplant wird."""
#     # Berechnen der Jobdauer aller jobs
#     jobs_duration = jobs_data.get_processing_time()  # list[int]
#     # Gleich 0 für LPT
...
if __name__ == "__main__":
    ...
    # makespan nach MWKR: 1458
    # Anz. krtische Operationen: 27
    # wenn möglich gerne zeigen welche bei dir kritisch sind, nicht dass die Anzahl zufällig gleich ist
