...
class NeighborHood:
    def __init__(self, init_solution, critical_path):
        ...
        self.current_solution = copy.deepcopy(init_solution)
        self.neighborhood = {}
    ...
    def create(self, arc):
        neighbor = neighborhood_solutions(schedule = self.current_solution, makespan = max(self.current_solution, key=lambda key: self.current_solution[key].end))
